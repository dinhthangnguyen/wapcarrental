...
carRouter.get('/api/today-pick/:limit',carController.getTodayPicks);
carRouter.get('/api/affordable/:limit',carController.getAffordables);
carRouter.get('/api/hot-pick/:limit',carController.getHotPicks);
